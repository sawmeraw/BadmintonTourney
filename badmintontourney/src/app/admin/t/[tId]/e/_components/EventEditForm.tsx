...
import { createTournamentAction, TournamentFormState, } from "@/lib/actions/TournamentActions";
...
export default function EventEditForm({initialData, eventTypes, templates, tournamentId} : EventFormProps){
  ...
  const actionToCall = isEditing ? updateEventAction.bind(null, initialData.id) : createEventAction.bind(null, tournamentId);
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="max_participants" id="max_participants" defaultValue={initialData?.max_participants || 0} step="1" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5" />
