...
interface EventFormProps {
    ...
    tournamentId: string;
    validationInfo: { success: boolean; details: string };
}
                            ...
                            <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    <TextField
                                        ...
                                        fullWidth
                                        defaultValue={
                                            initialData?.first_prize_money || 0
                                        }
                                        size="small"
                                        inputProps={{ step: "0.01" }}
                                        error={
                                ...
                                <div>
                                    <TextField
                                        ...
                                        fullWidth
                                        defaultValue={
                                            initialData?.second_prize_money || 0
                                        }
                                        size="small"
                                        error={
                                ...
                                <div>
                                    <TextField
                                        ...
                                        fullWidth
                                        defaultValue={
                                            initialData?.third_prize_money || 0
                                        }
                                        size="small"
                                        error={
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                            ...
                            <dl className="mt-4 grid grid-cols-2 gap-5">
                                ...
                                <StatCard
                                    ...
                                    value={
                                        initialData?.max_participants || "N/A"
                                    }
                                />
                            </dl>
                        </div>
                                ...
                                <div>
                                    ...
                                    {isEditing && (
                                        <p className="mt-1 text-xs text-gray-500">
                                            Format cannot be changed after
                                            creation.
                                        </p>
                                    )}
                                </div>
                                    ...
                                    <FormControlLabel
                                        control={
                                            <Checkbox
                                                ...
                                                defaultChecked={
                                                    initialData?.has_third_place_match ||
                                                    false
                                                }
                                                disabled={
                                                    initialData?.finalised_for_matches ||
