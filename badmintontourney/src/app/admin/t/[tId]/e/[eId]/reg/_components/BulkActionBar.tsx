...
export const BulkActionBar = () => {
  const {selectedIds, disableBulkUnseed, clearSelection, removeSeedFromSelected, deleteSelected} = useParticipantContext();
  ...
  return (
    <div className="absolute top-0 left-2 right-0 flex h-12 items-center z-50 space-x-3 pr-4 bg-gray-50 sm:left-16">
      ...
      <Button variant="secondary" size="sm" onClick={()=> alert('update clicked.')}>Update Status</Button>
