...
const participantStatusOptions = z.union([
    z.literal("active"),
    z.literal("withdrawn"),
    z.literal("disqualified"),
]);
const transformCheckboxtoBoolean = z.union([
...
export type UpdateFinalizedEventPayload = z.infer<
    typeof updateFinalizedEventSchema
>;
