...
export type ParticipantApiResponse = Pick<
    Participant,
    "id" | "seed" | "status"
> & {
...
export type ParticipantListApiResponse = {
    totalCount: number;
    participants: Array<ParticipantApiResponse>;
};
...
export type MatchSummary = Pick<
    ...
    | "round_match_number"
    | "winner_id"
    | "winner_feeds_into_match_id"
    | "loser_feeds_into_match_id"
    | "start_time"
    | "court_number"
>;
...
export type RoundDetails = Pick<EventRound, "id" | "name" | "sequence"> & {
    ...
    >;
    groups: Array<
        Pick<RoundGroup, "id" | "name"> & {
            participants: Array<
                Pick<Participant, "id"> & {
                    player1: PlayerBase | null;
                    player2: PlayerBase | null;
                }
            >;
        }
    ...
    matches: Array<
        MatchSummary & {
            ...
            sets: Array<
                Pick<
                    MatchSet,
                    "set_number" | "participant1_score" | "participant2_score"
                >
            >;
        }
    >;
